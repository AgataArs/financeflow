      ...
      <div className="h-72">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
            ...
            <XAxis dataKey="name" stroke="#64748b" fontSize={12} tickLine={false} axisLine={{ stroke: '#334155' }} />
            ...
            <ReferenceLine x={chartData[currentMonth]?.name} stroke="#6366f1" strokeWidth={2} strokeDasharray="5 5" label={{ value: 'Dziś', position: 'top', fill: '#6366f1', fontSize: 12 }} />
